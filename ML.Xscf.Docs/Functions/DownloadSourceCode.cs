    ...
    public class DownloadSourceCode : FunctionBase
    {
        public class DownloadSourceCode_Parameters : IFunctionParameter
        {
            ...
            public SelectionList Site { get; set; } = new SelectionList(SelectionType.DropDownList,new[] {
                   new SelectionItem(((int)Parameters_Site.GitHub).ToString(),Parameters_Site.GitHub.ToString()),
                   new SelectionItem(((int)Parameters_Site.Gitee).ToString(),Parameters_Site.Gitee.ToString()),
                });
        ...
        public override string Name => "下载官方 Scf 开发者文档";

        public override string Description => "下载盛派官方的最新 Scf 开发者文档";
